  ...
  <span className="text-transparent bg-clip-text bg-gradient-to-b from-zinc-200 to-zinc-600">
    TOTAL CLARITY.
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-8">
            <Link href='/dashboard' className="w-full sm:w-auto bg-white text-black px-8 md:px-12 py-4 md:py-6 rounded-full font-black text-lg md:text-2xl hover:bg-blue-600 hover:text-white transition-all transform hover:scale-105 active:scale-95 shadow-[0_0_50px_rgba(255,255,255,0.1)]">
              Start Building
            </Link>
